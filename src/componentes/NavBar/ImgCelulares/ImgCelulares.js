...
import ipad1 from './imagen3/ipad1.jpg';
import ipad2 from './imagen3/ipad2.jpg';
...
const ImgCelulares = () => {
    return (
      <div className="img-container">
        ...
        <div className="card">
          <img src={ipad1} alt="Tablets" className="card-img" />
        </div>
        <div className="card">
          <img src={ipad2} alt="Tablets2" className="card-img" />
        </div>
      </div>
    );
  };
